...
public class Arrays {
	...
	static void LoopTroughtArrayForEach() {
		String[] cars = { "Volvo", "BMW", "Ford", "Mazda" };
		for (String i : cars) {
...
If you compare the for loop and for-each loop, you will 
see that the for-each method is easier to write, it does not require a counter
